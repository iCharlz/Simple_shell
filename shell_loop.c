...
* Return: 0 success, 1 error, otherwise error code
*/
...
/**
* find_builtin - A function that finds builtin command
* @info: parameter and return info structure
* Return: -1 if builtin not found,
* 0 if builtin execution successful.
...
/**
* fork_cmd - A function that forks a exec thread to run cmd
